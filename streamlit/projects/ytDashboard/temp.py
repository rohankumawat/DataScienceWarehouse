...
def load_data():
    ...
    df_agg = pd.read_csv('D:/Github/DataScienceWarehouse/streamlit/projects/ytDashboard/Aggregated_Metrics_By_Video.csv').iloc[1:,:]
    ...
    df_agg_sub = pd.read_csv('D:/Github/DataScienceWarehouse/streamlit/projects/ytDashboard/Aggregated_Metrics_By_Country_And_Subscriber_Status.csv')
    df_comments = pd.read_csv('D:/Github/DataScienceWarehouse/streamlit/projects/ytDashboard/Aggregated_Metrics_By_Video.csv')
    df_time = pd.read_csv('D:/Github/DataScienceWarehouse/streamlit/projects/ytDashboard/Video_Performance_Over_Time.csv')
...
if add_sidebar == "Individual Video Analysis":
    # st.write("Ken Jee Individual Video Analysis")
